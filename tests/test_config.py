import pytest
from src.config import ActionSchema, ModelArguments, DataArguments, TrainingArguments
...
def test_data_arguments_defaults(data_args):
    ...
    assert data_args.dataset_name == "artryazanov/nitrogen-bizhawk-nes-felix-the-cat-world-1"
